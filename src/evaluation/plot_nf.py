...
# hc_eval = pd.read_csv(r'../../data/news_analysis.csv')
# hc = hc_eval.copy()
# hc_recalled = hc[hc.label=='reliable']
# hc_imagined = hc[hc.label=='fake']
...
plt.plot(x,density_heights_comb_smoothed, color='red')
