...
if __name__ == "__main__":
    ...
    if mode == 'hc':
        ...
        hc = pd.read_csv(r'partII_project/data/news_analysis.csv')
        ...
        logprobs_chain_summaries = get_stories_logprobs_chain('all_prev_sents', encoded_summaries, encoded_sentences,
                                                              chain_inputs_summaries)
        print('chain probs done')
        ...
        hc.to_csv(r'partII_project/data/news_analysis.csv', index=False)
        print('hc updated')